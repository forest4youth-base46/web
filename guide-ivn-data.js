 ...
 "chapters": [
  ...
  },
  {
   ...
   "blocks": [
    ...
    {
     "t": "p",
     "text": "This guide is a practical, evidence-informed companion for clinicians using immersive virtual nature (IVN) with adolescents and young adults (roughly aged 10–24) on mental health pathways."
    },
    {
     "t": "p",
     "text": "Rather than offering a one-size-fits-all approach, it provides structured options drawn from the experience of clinicians, researchers, technology developers, young people’s representatives, families, and forest professionals, which you can adapt to your service and to each individual young person."
    },
    {
     "t": "p",
     "text": "The guiding idea throughout is simple: IVN works best as a short, flexible, multisensory, personalized, and ethically explicit bridge between institutional care and real contact with the natural world."
    },
    {
     "t": "p",
     "text": "If you have any questions regarding the practical guide or its content, or if you would like advice on how to get started, please contact Mostafa El Madani (Mostafa.El.Madani@ulb.be) or Malgorzata Klass (malgorzata.klass@ulb.be)."
    },
    {
     "t": "p",
     "text": "This guide is the companion to the Forest-Based Interventions practical guide; the two are designed to be read together."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "In this guide, IVN refers primarily to virtual reality delivered via head-mounted displays (HMDs), and to immersive rooms, which are less widely available and less commonly used in institutions. For immersive-room setups, IVN typically involves large projected or displayed nature environments with a synchronized soundscape, combined with sensory-regulation tools such as dimmed lighting, comfortable and supported body positioning, tactile supports, and, where possible, scent or temperature cues."
    },
    {
     "t": "p",
     "text": "It is most useful to think of this not as a form of “gaming VR,” but rather as an enhanced immersive Snoezelen environment (i.e., a multisensory space designed to provide gentle sensory stimulation). As one clinician put it, \" what is really missing from virtual reality is the body\": the therapeutic value comes from engaging the body and the senses, not from the visuals alone. Another framed the room directly as a \"luxury snoezelen\"."
    },
    {
     "t": "p",
    ...
    {
     "t": "p",
     "text": "IVN was described as a complement, preparation for, or bridge to real nature, not a replacement for it. \"It should only be a supplement and not a substitute.\"; \"A stepping stone, not a replacement.\""
    },
    {
     "t": "p",
     "text": "In practice, IVN has two places in care:"
    },
    {
     "t": "ul",
     "items": [
      "preparing a young person before a real forest experience, and easing the return afterward (complementary approach).",
      "providing short sensory regulation when access to nature is not possible at all (alternative approach)."
     ]
    },
    {
     "t": "p",
    ...
    {
     "t": "p",
     "text": "Within those limits, IVN can be genuinely valuable in its own right, \"giving a freeing experience to someone who isn't free,\" and, in some clinicians' experience, even acting as \"an alternative to medication\" in moments of distress, but always as part of care plan."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "The guide is layered, so you can choose how much detail you need:"
    },
    {
     "t": "ul",
     "items": [
    ...
    {
     "t": "p",
     "text": "Everything offered here is an aid, not an instruction. Adapt it to your setting and to the young person in front of you."
    },
    {
     "t": "p",
  ...
  },
  {
   ...
   "blocks": [
    {
     "t": "p",
     "text": "A few principles run through every IVN session, whatever the module."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "Consider IVN when a young person is fearful of or unfamiliar with the forest or woodland, and a real nature visit is planned; when they need a brief way to settle or regulate within the ward; when they are returning from a forest experience and the re-entry feels abrupt; when a shared, low-pressure activity would help; or simply when real nature cannot be reached right now. IVN is particularly relevant where direct nature exposure is absent, infrequent, or difficult. It can also be valuable even when access to nature is readily available, by enhancing knowledge about forest environments and helping prepare individuals for real-life experiences in nature."
    },
    {
     "t": "p",
    ...
    {
     "t": "p",
     "text": "As one workshop group put it, \"we discussed a lot the preparation, what to do during, and what to do after.\""
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "Transitions are part of the intervention. The move from the everyday environment into the immersive room, and between the room and the real forest (for modules A and C), should be soft and consistent. A brief, repeatable entry and exit routine helps the young person cross from one \"world\" to another. \"When one passes from one space to another space, there must be a soft transition.\""
    },
    {
     "t": "p",
     "text": "Anticipate triggers before you begin. Draw on the young person's history to identify factors that may be distressing, such as specific environments, darkness or night scenes, or content associated with previous traumatic experiences. In IVN, the content of the session can be flexible and adapted to resolve such concerns."
    },
    {
     "t": "p",
     "text": "To be beneficial, immersive experiences must be carefully planned and delivered. Otherwise, they can raise anxiety rather than reduce it; without a minimal framework \"we can have the opposite effect.\" Choose environments and pacing accordingly, and keep an easy exit available throughout."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "Adolescents differ from one another in what they find soothing, tolerable, or meaningful: the environment, the intensity, guided versus unguided, alone versus with others. Choice is a core therapeutic ingredient. In restrictive settings, letting a young person choose can itself be therapeutic, because it restores a degree of control. \"Choice! choice to me is really important.\"; \"Some people love the mountains, some people love the coast.\""
    },
    {
     "t": "p",
     "text": "Keep the choice bounded. A structured choice among a small number of options, for example, four or five short, prepared experiences, works better than an overwhelming menu. The dimensions below are illustrative: offer choice across whichever ones your setup actually supports."
    },
    {
     "t": "ul",
     "items": [
      "Environment — forest / coast / mountain / marine / other",
      "Mode — calming-passive / guided / exploratory",
      "Sensory level — more or less stimulation",
      "Social format — alone / with a mental health practitioner / small group",
      "Purpose — calming / preparation / memory / connection"
     ]
    },
    {
     "t": "p",
    ...
    {
     "t": "p",
     "text": "Match realism to purpose. If the aim is to prepare for a specific real forest, a relatable or local environment helps; if the aim is calming or relief, the most meaningful or preferred environment may matter more."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "IVN is often viewed as an individual experience, but it can also be meaningfully shared. Both immersive rooms and head-mounted displays can serve as a shared relational space: two young people together, or a young person with a mental health practitioner. In immersive rooms, many people can enter the room at the same time, and in HMDs, synchronized \"tandem\" setups let two people share the same virtual environment at the same time. An example of this tandem approach has been developed by the Clemson Virtual Reality and Nature Lab (see: www.virtualnaturelab.org/tandemvr). Used this way, IVN can support peer connection, reduce loneliness, and build comfort and trust between staff and patient, with some reports of \"significant social anxiety reduction\" in shared formats."
    },
    {
     "t": "p",
     "text": "Let the social format follow the purpose. \"The format depends on whether you want an individual or social benefit.\" For individual regulation or preparation, solo or one-to-one usually fits; for connection, alliance, or playful engagement, a shared session may work better."
    },
    {
     "t": "p",
     "text": "A note on equipment: immersive rooms naturally lend themselves to group and shared use, while HMDs are often used individually but can also support two-person \"tandem\" sessions when synchronized."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "This is the strongest and most consistent message across the project: what makes IVN therapeutic is not the image, but how much it engages the body and the senses. Visual and auditory immersion alone are not enough."
    },
    {
     "t": "p",
     "text": "Build the experience as an embodied, multi-sensory environment:"
    },
    {
     "t": "ul",
     "items": [
      "A high-quality nature soundscape as a core element — \"the nature soundscape is very important\"",
      "Comfortable, supported body positioning — foam mats, cushions, a hammock, reclined seating; a sense of being physically held and supported",
      "Where feasible, scent and temperature cues — \"the smell is very important\"; \" leaf mats… feeling the smells\"",
      "Soft, low ambient lighting in the physical room"
     ]
    },
    {
     "t": "p",
     "text": "The guiding principle is that \"the more senses that are engaged, the greater the impact.\" Build sensory intensity gradually, and keep each element (sound, scent, lighting, temperature) adjustable up or down, so the experience can be dialled to what each young person can comfortably take in."
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "blocks": [
    {
     "t": "p",
     "text": "When implemented thoughtfully, IVN is generally a safe and well-tolerated intervention that can provide calming and restorative experiences, although its effects may vary across individuals and contexts. This section is more directive than the rest of the guide, because these are safety points. Risks differ by modality, so notes mark where headset use differs from the immersive room."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "Screen before first use, together with the young person and their clinical record. Where appropriate, use brief structured measures to support this screening (for example a susceptibility check for cybersickness)."
    },
    {
     "t": "ul",
     "items": [
      "Photosensitive epilepsy. Check for a personal or family history of seizures or photosensitivity. Avoid flickering, flashing, or rapidly changing high-contrast content. Calm nature scenes are usually low-risk, but verify first.",
      "Motion sensitivity / cybersickness. Ask about motion sickness and migraine. Cybersickness can occur with both HMDs and immersive rooms. Both its intensity and its duration are hard to predict. Symptoms may appear not only during the session but in the hours that follow, so monitor tolerance during the first exposure and check in afterwards. A validated tool such as the SSQ (Simulator Sickness Questionnaire) for example, administered before and after the session, can help track nausea and oculomotor symptoms over time.",
      "Clinical and diagnostic profile. Suitability depends on the young person's difficulties. Some presentations, for example active psychosis, marked dissociation, or certain trauma histories, call for more caution, more support, or may mean IVN is not appropriate at this time. Some young people need stronger sensory containment and bodily support to benefit at all.",
      "Trauma-linked content. Anticipate environments or elements that could reactivate difficult material, \"it brought that trauma back.\""
     ]
    },
    {
     "t": "p",
     "text": "For headset use, also check the manufacturer's age rating (many are 12–13+), the immersive room avoids this hardware limit."
    },
    {
     "t": "p",
    ...
    {
     "t": "p",
     "text": "Watch continuously, not only at the end. Physical signs include nausea, dizziness, pallor, sweating, headache, and eye strain. Emotional and behavioural signs include rising arousal or agitation, fear, tearfulness, freezing, dissociation, distress tied to the content, withdrawal, or any request to stop."
    },
    {
     "t": "h",
    ...
    },
    {
     "t": "ul",
     "items": [
      "Stop immediately if the young person asks, or if you see clear distress or physical symptoms.",
    ...
    },
    {
     "t": "ul",
     "items": [
      "Stop the session at any request, when physical symptoms do not settle, or in case of significant distress or dysregulation.",
      "Pause IVN for that young person if sessions repeatedly distress or destabilize them, and reconsider whether it is suitable for this person at this moment.",
      "Escalate and seek support through your service's existing procedures if a young person decompensates, expresses risk, or shows distress too severe to be managed within the session itself. IVN sits within your clinical safety and risk processes, not outside them."
     ]
    },
    {
     "t": "p",
  ...
  },
  {
   ...
   "blocks": [
    {
     "t": "p",
     "text": "This section turns evaluation into a simple, practical decision: start from your care intention for the session, choose the outcome that matches it, then pick a measure that fits. It is built to support the Forest4Youth pilot interventions, where each clinician selects what to measure according to what they are trying to achieve."
    },
    {
     "t": "p",
     "text": "Two principles shape everything here. First, measurement is intention-led, and the choice is yours: the guide offers a curated menu, not a fixed battery. Second, the measurement burden must match the session burden. Pairing a five-minute calming session with a long questionnaire only reduces engagement and data quality, \"surveys should be short and easy.\" Immediate effects are also the realistic first target, \"immediate effects will be easier to achieve,\" rather than large symptom change from the outset."
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "Most sessions use one of two tiers:"
    },
    {
     "t": "ul",
     "items": [
      "Quick per-session measures — a single-item scale (a 0–10 visual analogue), the Self-Assessment Manikin, or a brief state form, taken just before and just after. Light enough for a five-minute session or a repeated routine.",
      "Short validated questionnaires — used across a series, or before and after a forest stay, when you want a more robust read of change. Some constructs (broad wellbeing, depression, nature connectedness…) shift slowly and should be measured at baseline and the end of the programme, not session by session."
     ]
    },
    {
     "t": "h",
    ...
    },
    {
     "t": "ul",
     "items": [
      "Per session: immediately before and after (quick tier) — distress, calm, mood, perceived safety, plus a tolerability check.",
      "Across a series: one or more short validated questionnaires at the start and after several sessions.",
      "Around a forest stay: before Module A and after Module C, to capture readiness, nature connectedness, and the transition.",
      "Adapt the timing of your measures to the session's function — a five-minute decompression, a preparation session, and a shared relational session are not trying to produce the same change."
     ]
    },
    {
     "t": "h",
    ...
    {
     "t": "p",
     "text": "Numbers are only part of the picture, and in this population the qualitative side is essential rather than optional, \"my heart is always in the storytelling and the conversations.\" Observe during the session (engagement, arousal, comfort, distress), and hold a short debrief afterward: what was it like, what stood out, did it feel positive or negative. After repeated sessions or a forest stay, a longer conversation, exit interview, or simple photovoice can capture meaning that scales miss. One clinician called this the most important part of all."
    },
    {
     "t": "h",
  ...
  },
  {
   ...
   "blocks": [
    ...
    },
    {
     "t": "table",
     "head": [
      "Care intention (outcomes to improve)",
      "Measures"
     ],
     "rows": [
      [
       "Reduce anxiety\nAnxiety / state distress",
       "Anxiety VAS (0–10); SAM; STAI-S · GAD-7; SCARED or RCADS-47; HADS-A; SIAS (social)"
      ],
      [
       "Reduce stress\nStress",
       "Stress VAS · PSS (short)"
      ],
      [
       "Lift / stabilise mood\nMood & affect",
       "VAMS; SAM; I-PANAS-SF · POMS-SF; PANAS"
      ],
      [
       "Calm / regulate\nRelaxation & bodily calm",
       "RSQ; Relaxation VAS; SAM (arousal)"
      ],
      [
       "Restore / recover\nRestoration & vitality",
       "ROS; SVS (vitality) · PRS-11 or SRRS (restorativeness)"
      ],
      [
       "Interrupt rumination\nEmotion regulation & rumination",
       "State mindfulness (SMS / MAAS) · ERQ-CA; RRS"
      ],
      [
       "Support wellbeing\nWellbeing (broad)",
       "SWEMWBS; WHOQOL-26"
      ...
      [
       "Engage / acceptability\nEngagement, enjoyment, acceptability",
       "Single-item Likert · PACES; IMI; SUS (usability)"
      ],
      [
       "Help feel safe\nPerceived safety",
      ...
      [
       "Prepare for / reconnect with nature\nNature connectedness, appreciation, exposure & intention",
       "INS (1 pictorial item); “readiness to go to the forest” single item; NR-6; CNS or NCI (connectedness); VAS (appreciation of / aversion to nature); NES, 4-item (nature exposure); VAS or open questions (intention to spend time in nature)"
      ],
      [
       "Gauge the IVN experience\nPresence & usability (process)",
       "IPQ or SPES (presence); SUS (usability)"
      ],
      [
       "Let the young person define it\nPatient-generated",
       "PSYCHLOPS"
      ],
      [
       "Capture meaning\nQualitative",
       "Short debrief · Exit interview; open questions; photovoice; field diary"
      ],
      [
       "Tolerability\nCybersickness",
       "Tolerability single item; single-item discomfort or nausea rating (0–10); brief pre-immersion motion-sickness screen (MSR) · SSQ before and after each immersion (total score + nausea and oculomotor sub-scores); at intake, susceptibility scales MSSQ-short and VIMSSQ-short"
      ]
     ]
    },
    {
    ...
    {
     "t": "p",
     "text": "Abbreviations: VAS, Visual Analogue Scale; SAM, Self-Assessment Manikin; STAI-S, State-Trait Anxiety Inventory – State; GAD-7, Generalised Anxiety Disorder 7-item scale; SCARED, Screen for Child Anxiety Related Emotional Disorders; RCADS(-47), Revised Children's Anxiety and Depression Scale (47-item); HADS-A, Hospital Anxiety and Depression Scale – Anxiety; SIAS, Social Interaction Anxiety Scale; BAI-Y, Beck Anxiety Inventory for Youth; MASC-2, Multidimensional Anxiety Scale for Children, 2nd edition; PSS, Perceived Stress Scale; VAMS, Visual Analogue Mood Scales; PANAS, Positive and Negative Affect Schedule; I-PANAS-SF, International Positive and Negative Affect Schedule – Short Form; POMS-SF, Profile of Mood States – Short Form; PHQ-A, Patient Health Questionnaire for Adolescents; RSQ, Relaxation State Questionnaire; ROS, Restoration Outcome Scale; SVS, Subjective Vitality Scale; PRS-11, Perceived Restorativeness Scale, 11-item; SRRS, Short-version Revised Restoration Scale; SMS, State Mindfulness Scale; MAAS, Mindful Attention Awareness Scale; ERQ-CA, Emotion Regulation Questionnaire for Children and Adolescents; RRS, Ruminative Responses Scale; SWEMWBS, Short Warwick-Edinburgh Mental Wellbeing Scale; WHOQOL-26, World Health Organization Quality of Life, 26-item; PACES, Physical Activity Enjoyment Scale; IMI, Intrinsic Motivation Inventory; SUS, System Usability Scale; INS, Inclusion of Nature in Self scale; NR-6, Nature Relatedness, 6-item; CNS, Connectedness to Nature Scale; NCI, Nature Connectedness Index; NES, Nature Exposure Scale; IPQ, Igroup Presence Questionnaire; SPES, Spatial Presence Experience Scale; SSQ, Simulator Sickness Questionnaire; MSR, Motion Sickness Rating scale; MSSQ-short, Motion Sickness Susceptibility Questionnaire – short form; VIMSSQ-short, Visually Induced Motion Sickness Susceptibility Questionnaire – short form; PSYCHLOPS, Psychological Outcome Profiles."
    },
    {
     "t": "p",
