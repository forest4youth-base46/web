...
const ACTIVITIES = [
  ...
  { id:'soundscape', group:1, name:'The Soundscape Map', durMin:10, durMax:15, durAvg:12, glyph:'ear', visual:'soundscape',
    ...
    materials:'Paper, pencil and a clipboard per person.',
  ...
  { id:'naming', group:1, name:'Getting to Know the Forest', durMin:5, durMax:10, durAvg:7, glyph:'leaf', visual:'naming',
    ...
    close:'No formal close. It dissolves into the walk.',
  ...
  { id:'hammock', group:1, name:'The Hammock', durMin:30, durMax:60, durAvg:45, glyph:'hammock', visual:'hammock',
    ...
    close:'No structured close. Let young people leave when ready, and have the next activity quietly ready for this.',
  ...
  { id:'barefoot', group:2, name:'Barefoot Trail', durMin:10, durMax:15, durAvg:12, glyph:'foot', visual:'barefoot',
    ...
    materials:'A short varied path of grass, soil, bark, moss and stone.',
  ...
  { id:'palette', group:2, name:'Colour Palette Walk', durMin:15, durMax:20, durAvg:17, glyph:'swatch', visual:'palette',
    ...
    materials:'A laminated colour palette or paint chips per person.',
    ...
    close:'Gather the group. Who found a surprising match? In autumn, make a palette from fallen leaves instead.',
  ...
  { id:'tinyworld', group:2, name:'Build a Tiny World', durMin:45, durMax:60, durAvg:52, glyph:'tinyworld', visual:'tinyworld',
    ...
    intro:'"We\'re going to create an imaginary world using only what we can find. Work in small groups for about an hour. There\'s no right or wrong way."',
    close:'Signal the end a few minutes early. Invite groups to walk through each other\'s worlds. Return materials to the ground.',
    tags:['Groups','Children','Creative work']
  },
  ...
  { id:'fire', group:3, name:'Fire Lighting', durMin:45, durMax:60, durAvg:52, glyph:'flame', visual:'fire',
    ...
    materials:'Site permission, safety clearance and a competent practitioner. Fire steel or matches, tinder, kindling, fuel wood, a fire circle, water nearby.',
  ...
  { id:'bivouac', group:3, name:'Bivouac Building', durMin:45, durMax:60, durAvg:52, glyph:'shelter', visual:'bivouac',
    ...
    close:'Test it together. Sit inside. Enjoy the achievement.',
  ...
  { id:'sitspot', group:4, name:'The Sit Spot', durMin:15, durMax:20, durAvg:17, glyph:'spot', visual:'sitspot',
    ...
    materials:'15–20 minutes unstructured, and a site with enough variety for individual spots within earshot.',
  ...
  { id:'roles', group:4, name:'Distributed Responsibility', durMin:0, durMax:0, durAvg:0, durLabel:'Throughout session', glyph:'roles', visual:'roles',
    ...
    materials:'Specific practical roles agreed before departure: who carries cups, who carries tea, who checks the path, who holds the map.',
  ...
  { id:'project', group:4, name:'The Individual Project', durMin:0, durMax:0, durAvg:0, durLabel:'Multi-session', glyph:'seedling', visual:'project',
    ...
    materials:'Session time, and on-site materials.',
  ...
  { id:'object', group:5, name:'The Forest Object', durMin:5, durMax:10, durAvg:7, glyph:'pebble', visual:'object',
    ...
    materials:'Permission to take small fallen and found objects.',
    intro:'"Before we go, find something small that nature has already let go of. Something you want to take with you from today. You don\'t need to explain why."',
  ...
  { id:'checkin', group:5, name:'The Silent Self Check-in', durMin:2, durMax:5, durAvg:3, glyph:'check', visual:'checkin',
    caption:'A private moment of noticing, held quietly within',
    purpose:'Brief self-assessment before leaving. Builds self-reflection as a habit.',
    materials:'Nothing. Find a good place before the end of the forest paths; ask everyone to think without any need to share.',
    intro:'"Take a silent moment to check inside yourself for how you feel now. Much better? A bit worse? This is for you to note, no one else needs to know."',
    close:'Quietly be sure that the group has had enough time. Move on when ready.',
  ...
  { id:'campfire', group:5, name:'Campfire Close', durMin:10, durMax:15, durAvg:12, glyph:'ember', visual:'campfire',
    ...
    materials:'A fire from the session, or tea on a small stove if there is no fire.',
